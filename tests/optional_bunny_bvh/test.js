...
//         new PhongMaterial(Vec.of(1,1,1), 0.3, 0.4, 0.6, 100, 0.5)));
    objs.push(new SceneObject(
        new Plane(Vec.of(0, 1, 0, 0), 1),
...
//              .times(Mat4.scale(15)),
        ...
        function(triangles) {
            callback({
                renderer: new SimpleRenderer(new BVHScene(objs.concat(triangles), lights/*, Vec.of(0.53, 0.81, 0.92).times(0.6)*/), camera, 4),
                width: 600,
                height: 600
            });
        });
