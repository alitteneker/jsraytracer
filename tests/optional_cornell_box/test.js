function configureTest(callback) {
    ...
    lights.push(new RandomSampleAreaLight(
        ...
        Vec.of(1,1,1), 128));
//     lights.push(new SimplePointLight(Vec.of(0,9.9,0), Vec.of(1,0,0)));
    ...
    loadObjFile(
        ...
        function(objects) {
            ...
            // objects
//             objects.push(new SceneObject(
//                 new AABB(Vec.of(1.2, 1.2, -5, 1), Vec.of(1,1,1,0)),
//                 new PhongMaterial(Vec.of(1,0,0), 0.2, 0.4, 0.6, 100, 0.5)));
            ...
            callback({
                renderer: new /*RandomMultisamplingRenderer*/IncrementalMultisamplingRenderer(new Scene(objects, lights), camera, 32, 4),
                width: 300,
                height: 300
            });
        });
